...
def check_all_mess(mes):
    ...
    response('It has a mileage of 23 to 31 kmpl', ['how', 'much', 'is', 'the','mileage'], required_words=['mileage'])
    response('It has a fuel tank capacity of 37 litres.', ['what', 'is', 'the', 'fuel' , 'tank','capacity'], required_words=['fuel'])
    ...
    response('Models available are:\n\t1.Swift Dzire LXI\n\t2.Swift Dzire VXI\n\t3.Swift Dzire ZXI ', ['what', 'models', 'are', 'available'], required_words=['models'])
    response('Models available are \n\t1.Swift Dzire LXI\n\t2.Swift Dzire VXI\n\t3.Swift Dzire ZXI', ['what', 'model', 'is', 'available'], required_words=['model'])
    response('Price range for this car is 6 lacs to 9 lacs', ['what', 'is', 'price', 'range'], required_words=['price'])
    ...
    response('It\'s average user rating is 4.2', ['what', 'is','the','average','rating'], required_words=['rating'])
    ...
    response('It Has 425 Horsepower(HP) petrol and diesel engine', ['engine'], required_words=['engine'])
